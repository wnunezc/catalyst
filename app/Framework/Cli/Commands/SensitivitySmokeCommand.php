...
/**
 * sensitivity:smoke CLI command.
 *
 * Responsibility: Runs the sensitivity:smoke command to Exercise canonical PA-03 classification and redaction across audit/API/export/version payloads.
 *
