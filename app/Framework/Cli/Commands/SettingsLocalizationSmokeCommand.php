...
final class SettingsLocalizationSmokeCommand extends AbstractCommand
{
    ...
    {
        return 'settings:localization-smoke';
    }
    ...
    {
        return 'Verify semantic Settings page translations';
    }
    ...
    public function execute(ArgumentBag $args): int
    {
        ...
        $this->line('');
        $this->info('Settings Localization Smoke');
        ...
        $this->line(str_repeat('-', 74));
        $ok
            ? $this->success('Settings page translation semantics are coherent.')
            : $this->error('Settings page translation semantics have issues.');
        $this->line('');
    ...
    private function checkLocale(string $locale): array
    {
        ...
        $translator->addPath(PD . DS . 'Repository' . DS . 'Framework' . DS . 'Settings' . DS . 'lang');
    ...
    private function findRenderedGridIssues(array $cards, array $groups, string $globalTitle): array
    {
        ...
        $settingsViews = PD . DS . 'Repository' . DS . 'Framework' . DS . 'Settings' . DS . 'Views';
