...
/**
 * reporting:smoke CLI command.
 *
 * Responsibility: Runs the reporting:smoke command to Exercise canonical PA-10 queue + retry + persisted output flows over the unified reporting pipeline.
 *
