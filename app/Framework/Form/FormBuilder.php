...
/**
 * Fluent builder for reusable form view models.
 *
 * @package Catalyst\Framework\Form
...
final class FormBuilder
{
    ...
    private function normalizeActions(array $actions): array
    {
        ...
        foreach ($actions as $action) {
            ...
            $normalized[] = [
                ...
                'label' => (string) ($action['label'] ?? __('ui.form_builder.save')),
    ...
    private function normalizeAttributes(array $attributes): array
    {
        ...
        foreach ($attributes as $key => $value) {
            ...
            if (
                $attribute === ''
                || preg_match('/^[A-Za-z_:][A-Za-z0-9:._-]*$/', $attribute) !== 1
                || str_starts_with(strtolower($attribute), 'on')
            ) {
                continue;
            }
