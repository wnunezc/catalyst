...
final class OrganizationHierarchyController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->view('roles.organization-hierarchy', [
            'title' => (string)__('roles.organization_admin.title'),
            'pageTitle' => (string)__('roles.organization_admin.title'),
    ...
    public function storeOrganization(Request $request): Response
    {
        ...
        return $this->postActionSuccessRedirect('/users/organization-hierarchy', (string)__('roles.organization_admin.messages.organization_saved'));
    }
    ...
    public function storeUnit(Request $request): Response
    {
        ...
        return $this->postActionSuccessRedirect('/users/organization-hierarchy', (string)__('roles.organization_admin.messages.unit_saved'));
    }
    ...
    public function storeScope(Request $request): Response
    {
        ...
        return $this->postActionSuccessRedirect('/users/organization-hierarchy', (string)__('roles.organization_admin.messages.scope_saved'));
    }
    ...
    public function storeLevel(Request $request): Response
    {
        ...
        return $this->postActionSuccessRedirect('/users/organization-hierarchy', (string)__('roles.organization_admin.messages.level_saved'));
    }
    ...
    private function requiredText(Request $request, string $key, int $max): string
    {
        ...
        if ($value === '' || mb_strlen($value) > $max) {
            throw new InvalidArgumentException((string)__('roles.organization_admin.messages.invalid_payload'));
        }
    ...
    private function slug(Request $request, string $key, int $max): string
    {
        ...
        if ($value === '' || mb_strlen($value) > $max || !preg_match('/^[a-z0-9][a-z0-9-]*$/', $value)) {
            throw new InvalidArgumentException((string)__('roles.organization_admin.messages.invalid_key'));
        }
    ...
    private function color(Request $request, string $key): ?string
    {
        ...
        if (!preg_match('/^#[0-9a-fA-F]{6}$/', $value)) {
            throw new InvalidArgumentException((string)__('roles.organization_admin.messages.invalid_color'));
        }
    ...
    {
        return $e instanceof InvalidArgumentException ? $e->getMessage() : (string)__('roles.organization_admin.messages.save_failed');
    }
}
