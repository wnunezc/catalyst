...
return static function (array $scope): array {
    ...
    foreach ((array) ($scope['versions'] ?? []) as $version) {
        ...
        $versionsRows[] = [
            ...
            'restore_url' => '/operations/automation-rules/' . (int) ($rule['id'] ?? 0) . '/versions/' . (int) ($version['id'] ?? 0) . '/restore',
        ];
    }
    ...
    return [
        'page_header' => [
            ...
            'actions' => [
                ['label' => __('automation.show.actions.edit'), 'href' => '/operations/automation-rules/' . (int) ($rule['id'] ?? 0) . '/edit', 'class' => 'btn btn-sm btn-outline-primary', 'icon' => 'fa-solid fa-pen'],
                ['label' => __('automation.show.actions.back'), 'href' => '/operations/automation-rules', 'class' => 'btn btn-sm btn-outline-secondary', 'icon' => 'fa-solid fa-arrow-left'],
            ],
            'metrics' => [
        ...
        'rule' => [
            ...
            'edit_url' => '/operations/automation-rules/' . (int) ($rule['id'] ?? 0) . '/edit',
            'transition_url' => '/operations/automation-rules/' . (int) ($rule['id'] ?? 0) . '/transition',
            'run_url' => '/operations/automation-rules/' . (int) ($rule['id'] ?? 0) . '/run',
        ],
