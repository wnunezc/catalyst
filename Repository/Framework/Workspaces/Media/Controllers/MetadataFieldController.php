...
use Catalyst\Repository\Workspaces\Media\Requests\MetadataFieldDefinitionRequest;
use Catalyst\Repository\Workspaces\Media\Support\MetadataFieldFormFactory;
...
final class MetadataFieldController extends Controller
{
    ...
    {
        $this->authorizeResource('view-any', 'workspaces-media-fields');
        ...
        if (in_array($gridBuilder->exportFormat($request), ['csv', 'xls'], true)) {
            $this->authorizeResource('export', 'workspaces-media-fields');
    ...
    {
        $this->authorizeResource('create', 'workspaces-media-fields');
    ...
    public function edit(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('view', 'workspaces-media-fields', $field);
    ...
    public function update(MetadataFieldDefinitionRequest $request, string $id): Response
    {
        ...
        $this->authorizeResource('update', 'workspaces-media-fields', $model->toArray());
    ...
    public function destroy(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('delete', 'workspaces-media-fields', $model->toArray());
