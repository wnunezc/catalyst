...
use Catalyst\Repository\Workspaces\Media\Support\MediaLibraryFormFactory;
...
final class MediaLibraryController extends Controller
{
    ...
    {
        $this->authorizeResource('view-any', 'workspaces-media-library');
        ...
        if (in_array($gridBuilder->exportFormat($request), ['csv', 'xls'], true)) {
            $this->authorizeResource('export', 'workspaces-media-library');
    ...
    {
        $this->authorizeResource('create', 'workspaces-media-library');
    ...
    public function edit(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('view', 'workspaces-media-library', $media);
    ...
    public function update(MediaItemRequest $request, string $id): Response
    {
        ...
        $this->authorizeResource('update', 'workspaces-media-library', $item->toArray());
    ...
    public function destroy(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('delete', 'workspaces-media-library', $item->toArray());
    ...
    {
        $this->authorizeResource('bulk-delete', 'workspaces-media-library');
