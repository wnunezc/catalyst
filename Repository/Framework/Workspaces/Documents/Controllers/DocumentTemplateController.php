...
namespace Catalyst\Repository\Workspaces\Documents\Controllers;
...
use Catalyst\Repository\Workspaces\Documents\Actions\DocumentTemplateMutationService;
use Catalyst\Repository\Workspaces\Documents\Actions\DocumentTemplatePreviewService;
use Catalyst\Repository\Workspaces\Documents\Requests\DocumentExportPayloadRequest;
use Catalyst\Repository\Workspaces\Documents\Requests\DocumentPreviewPayloadRequest;
use Catalyst\Repository\Workspaces\Documents\Requests\DocumentTemplateRequest;
use Catalyst\Repository\Workspaces\Documents\Requests\DocumentTemplateTransitionRequest;
use Catalyst\Repository\Workspaces\Documents\Support\DocumentPreviewState;
use Catalyst\Repository\Workspaces\Documents\Support\DocumentTemplateFormFactory;
use Catalyst\Repository\Workspaces\Documents\Support\DocumentTemplateGridFactory;
use Catalyst\Repository\Workspaces\Documents\Support\DocumentTemplateShowDataFactory;
...
final class DocumentTemplateController extends Controller
{
    ...
    {
        $this->authorizeResource('view-any', 'workspaces-document-templates');
    ...
    {
        $this->authorizeResource('create', 'workspaces-document-templates');
    ...
    public function edit(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('view', 'workspaces-document-templates', $template);
    ...
    public function update(DocumentTemplateRequest $request, string $id): Response
    {
        ...
        $this->authorizeResource('update', 'workspaces-document-templates', $template->toArray());
    ...
    public function destroy(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('delete', 'workspaces-document-templates', $template->toArray());
    ...
    public function preview(DocumentPreviewPayloadRequest $request, string $id): Response
    {
        ...
        $this->authorizeResource('view', 'workspaces-document-templates', $template->toArray());
    ...
    public function export(DocumentExportPayloadRequest $request, string $id): Response
    {
        ...
        $this->authorizeResource('export', 'workspaces-document-templates', $template->toArray());
    ...
    public function restoreVersion(Request $request, string $id, string $versionId): Response
    {
        ...
        $this->authorizeResource('restore', 'workspaces-document-templates', $template->toArray());
