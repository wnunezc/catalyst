...
namespace Catalyst\Repository\Workspaces\Catalogs\Controllers;
...
use Catalyst\Repository\Workspaces\Catalogs\Actions\CatalogMutationService;
use Catalyst\Repository\Workspaces\Catalogs\Requests\CatalogDefinitionRequest;
use Catalyst\Repository\Workspaces\Catalogs\Requests\CatalogItemRequest;
use Catalyst\Repository\Workspaces\Catalogs\Support\CatalogFormFactory;
use Catalyst\Repository\Workspaces\Catalogs\Support\CatalogGridFactory;
...
final class CatalogController extends Controller
{
    ...
    {
        $this->authorizeResource('view-any', 'workspaces-catalogs');
    ...
    {
        $this->authorizeResource('create', 'workspaces-catalogs');
    ...
    public function edit(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('view', 'workspaces-catalogs', $catalog);
    ...
    public function update(CatalogDefinitionRequest $request, string $id): Response
    {
        ...
        $this->authorizeResource('update', 'workspaces-catalogs', $catalog->toArray());
    ...
    public function destroy(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('delete', 'workspaces-catalogs', $catalog->toArray());
    ...
    public function restoreVersion(Request $request, string $id, string $versionId): Response
    {
        ...
        $this->authorizeResource('restore', 'workspaces-catalogs', $catalog->toArray());
    ...
    public function createItem(Request $request, string $id): Response
    {
        ...
        $this->authorizeResource('create', 'workspaces-catalogs', $catalog);
    ...
    public function updateItem(CatalogItemRequest $request, string $id, string $itemId): Response
    {
        ...
        $this->authorizeResource('update', 'workspaces-catalogs', $catalog);
    ...
    public function destroyItem(Request $request, string $id, string $itemId): Response
    {
        ...
        $this->authorizeResource('delete', 'workspaces-catalogs', $catalog);
