...
final class AutomationRuleGridFactory
{
    ...
    public function build(AutomationRuleRepository $repository): DataGrid
    {
        return DataGrid::make()
            ...
            ->actions([
                ['label' => __('automation.index.actions.view'), 'class' => 'btn btn-outline-secondary btn-sm', 'href' => '/automation-rules/{id}'],
                ['label' => __('automation.index.actions.edit'), 'class' => 'btn btn-outline-primary btn-sm', 'href' => '/automation-rules/{id}/edit'],
                [
