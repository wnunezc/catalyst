...
use Catalyst\Repository\Users\Requests\PermissionPayloadRequest;
use Catalyst\Repository\Users\Requests\PermissionBulkSelectionRequest;

/**
 * Manages the privileged permission catalog and its edit forms.
 *
...
class PermissionsController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->view('users.permissions-list', [
    ...
    public function bulkDestroy(Request $request): Response
    {
        ...
        $payload = new PermissionBulkSelectionRequest($request);
        $ids = $payload->ids();
    ...
    private function renderForm(string $title, ?array $permission, ?array $claim = null): Response
    {
        ...
        return $this->view('users.permission-form', [
            'title' => $title,
            'pageTitle' => $title,
