...
- Este archivo aplica a `Repository/Framework/MigrationUi/` y a sus recursos acoplados.

## Contrato local

1. La superficie pública final de este módulo es `/demo-ui`, no `/migration-ui`.
