...
/**************************************************************************************
 *
 * Catalyst PHP Framework — Settings Module Routes
 *
 * Canonical setup and health routes live under /configuration/*.
 * Access control is handled by SetupGuardMiddleware:
 *   - Not configured → open access (no DB, no login possible)
