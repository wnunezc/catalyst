...
/**
 * Probes whether the configured database contains an active privileged account.
 *
 ...
 */
final class PrivilegedAccountReadinessProbe
{
    /**
     * Returns whether the required active role assignment can be found.
     *
     * Responsibility: Returns whether the required active role assignment can be found.
     * @param array<string, mixed> $db
     */
    public function hasActivePrivilegedAccount(array $db): bool
    {
