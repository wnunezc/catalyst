 ...
 *
 * Responsibility: Keeps first-run, public probe, and protected administration policies explicit during vertical migrations.
 */
final class ConfigurationAccessContract
{
    ...
    public const ADMIN_THROTTLE = 'admin_mutation';
    ...
    /**
     * Returns middleware for protected configuration administration.
     *
     * Responsibility: Requires authentication and the Configuration permission with its administrative fallback.
     ...
     *
     * Responsibility: Documents authentication and authorization outcomes for administrative surfaces.
     * @return array<string, string>
     */
