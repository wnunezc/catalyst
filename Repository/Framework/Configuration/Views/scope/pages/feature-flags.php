...
return static function (array $scope): array {
    ...
    foreach ((array) ($scope['catalogRows'] ?? []) as $row) {
        ...
        $scopeKey = 'settings.feature_flags.catalog.scopes.' . str_replace('-', '_', (string) ($row['scope'] ?? 'runtime'));
        ...
        $catalogRows[] = [
            ...
            'read_only' => $readOnly,
            'read_only_label' => __('settings.feature_flags.catalog.read_only'),
            ...
            'toggle_label' => $enabled
                ? __('settings.feature_flags.catalog.actions.disable')
                : __('settings.feature_flags.catalog.actions.enable'),
        ];
    }
