...
final class AppearanceUpdateRequest
{
    ...
    /**
     * Returns whether the shared theme customizer is enabled.
     *
     * Responsibility: Returns whether the shared theme customizer is enabled.
     */
    public function customizerEnabled(): bool
    {
        return $this->checkboxValue($this->request->input('customizer_enabled'));
    }
