...
use Catalyst\Repository\Configuration\Requests\AppearanceUpdateRequest;
...
final class AppearanceController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->view('configuration.appearance', [
            'title' => __('settings.appearance.page_title'),
            'pageTitle' => __('settings.appearance.page_title'),
    ...
    public function update(Request $request): Response
    {
        ...
        if (!array_key_exists($data['theme_family'], $themeCatalog)) {
            return $this->postActionErrorRedirect('/configuration/platform-appearance', __('settings.appearance.messages.invalid_theme'), 422);
        }
        ...
        if (preg_match('/^#[0-9A-F]{6}$/', $data['pdf_watermark_color']) !== 1) {
            return $this->postActionErrorRedirect('/configuration/platform-appearance', __('settings.appearance.messages.invalid_watermark_color'), 422);
        }
        ...
        $manager->writeSettings([
            'ui' => [
                'customizer_enabled' => $customizerEnabled,
                'mode' => $customizerEnabled ? 'user' : 'locked',
        ...
        return $this->postActionSuccessRedirect('/configuration/platform-appearance', __('settings.appearance.messages.updated'));
    }
