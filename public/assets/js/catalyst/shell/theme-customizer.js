...
function isCustomizerLocked() {
    ...
    return appearance.customizerEnabled === false || appearance.customizer_enabled === false;
}
...
export function initShellThemeCustomizer(options = {}) {
    ...
    const quickToggleSelector = typeof options.quickToggleSelector === 'string' && options.quickToggleSelector !== ''
        ...
        : '.catalyst-status-bar [data-catalyst-theme-toggle], .catalyst-status-bar [data-theme-quick-toggle]';
    ...
    panelBackdrop.className = 'catalyst-theme-backdrop';
    ...
    const applyConfig = () => {
        ...
        html.setAttribute('data-catalyst-theme-mode', state.config.theme);
