...
const seriesData = [
    { x: new Date(1483228800000), y: [51.98, 56.29, 51.59, 53.85] },
    { x: new Date(1485907200000), y: [53.66, 54.99, 51.35, 52.95] },
    { x: new Date(1488326400000), y: [52.96, 53.78, 51.54, 52.48] },
    { x: new Date(1491004800000), y: [52.54, 52.79, 47.88, 49.24] },
    { x: new Date(1493596800000), y: [49.1, 52.86, 47.7, 52.78] },
    { x: new Date(1496275200000), y: [52.83, 53.48, 50.32, 52.29] },
    { x: new Date(1498867200000), y: [52.2, 54.48, 51.64, 52.58] },
    { x: new Date(1501545600000), y: [52.76, 57.35, 52.15, 57.03] },
    { x: new Date(1504224000000), y: [57.04, 58.15, 48.88, 56.19] },
    { x: new Date(1506816000000), y: [56.09, 58.85, 55.48, 58.79] },
    { x: new Date(1509494400000), y: [58.75, 62.1, 57.51, 61.37] },
    { x: new Date(1512086400000), y: [61.39, 70.31, 61.39, 68.66] },
]

const seriesDataLinear = seriesData.map((point, index) => {
    const change = Math.round((point.y[3] - point.y[0]) * 120000)
    const directionalBias = index % 2 === 0 ? 1 : -1
    return {
        x: point.x,
        y: change === 0 ? directionalBias * 125000 : change,
    }
})

function formatCandlestickCategoryLabel(value) {
        ...
        xaxis: {
            ...
            labels: {
                formatter: function (val) {
                    return formatCandlestickCategoryLabel(val)
                },
            },
        },
        yaxis: {
