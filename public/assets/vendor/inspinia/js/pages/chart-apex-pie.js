...
new CustomApexChart({
    ...
    options: () => ({
        ...
        fill: {
            ...
            image: {
                src: [
                    `${chartVendorBase}/images/stock/small-1.jpg`,
                    `${chartVendorBase}/images/stock/small-2.jpg`,
                    `${chartVendorBase}/images/stock/small-3.jpg`,
                    `${chartVendorBase}/images/stock/small-4.jpg`,
                ],
                width: 25,
                imagedHeight: 25,
            },
