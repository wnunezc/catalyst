...
/**
 * Migrates persisted Audit module overrides to the canonical Operations owner.
 *
...
return new class extends Migration {
    private const string SOURCE = 'module.framework.audit';
    private const string TARGET = 'module.framework.operations';
    private const string JOURNAL = 'operations_audit_feature_flag_migration';
    private const string LEGACY_SHARED_JOURNAL = 'documents_feature_flag_migration';

    public function getVersion(): string
    {
        return '20260612050000';
    }
