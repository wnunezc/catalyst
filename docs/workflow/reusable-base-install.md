...
- canonical Configuration, Users, Account, Workspaces, Operations and API
  owners under `Repository/Framework/`;
...
- the canonical document/shell and central frontend runtime;
- internal transport routes migrated from `/api/*` to `/runtime/*`;
- framework/app test ownership and Playwright suite selection.
