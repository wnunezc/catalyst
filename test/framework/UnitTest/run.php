...
require $autoload;
require __DIR__ . DIRECTORY_SEPARATOR . 'TestCase.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'Support' . DIRECTORY_SEPARATOR . 'Assert.php';
...
if ($count === 0) {
    fwrite(STDOUT, "No unit tests found.\n");
    exit(0);
}
...
fwrite(STDOUT, "Unit tests passed ({$count}).\n");
